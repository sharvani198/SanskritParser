...
if __name__=='__main__':
    print("Word : StemString EndString \n"+
                  "POS - Noun,Verb,Pronoun,Indeclinable \n"+
                  "if N - (endLetter,Gender) "+
                  "if V - pratyaya\n"+
                  "each Noun form: [Vibhakti,Number]\n"+
                  "each Verb form: [Pada, Tense, Person, Number]")
    main()
